...
fun SignupPage(navController: NavController) {
    ...
    Column(
        ...
        androidx.compose.material.Text(
            text = "Signup Page", style = MaterialTheme.typography.headlineLarge,
        ...
        OutlinedTextField(
            ...
            placeholder = { Text(text = "Minimum 8 characters") },
        ...
        OutlinedTextField(
            ...
            onValueChange = { newPassword -> reenterPassword = newPassword },
            singleLine = true,
            leadingIcon = passwordLeadingIcon,
        )
